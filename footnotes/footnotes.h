...
!\
 (Footnote functionality has been added to Roodylib so now this extension
 only exists for non-Roodylib games.)
...
3. call "FootnoteNotify" in the main routine *after* runevents
...
routine PrintFootnote(num)
{
	select num
			case 1
				"Actually, this game was also submitted to the 2011 Hugo Comp.
				That's TWO comps! Crazy, right?"
			case 2
	...
	Calling Footnote(case number) will automatically print "(Footnote <next
	footnote number>)" instantly and add <case number> from PrintFootnote to
	your footnote array.
...
#ifset VERSIONS
#message "Footnotes.h Version 1.4"
#endif
